  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-16 text-center">
      <img
        ...
        style={{
          boxShadow: "0 0 20px var(--color-accent-cyan), 0 0 40px var(--color-accent-purple)",
        }}
      />
      ...
      <p className="mt-6 text-lg text-text-secondary leading-relaxed max-w-xl mx-auto">
        ...
        Gamer, streamer, and open source enthusiast. Follow along on YouTube for live streams and
        videos, or check out my projects on GitHub.
      </p>
    </main>
  );
}
